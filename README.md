...
| 类型 | ✅ | 收入 / 支出 | `支出` | 填写「收入」或「支出」（旧版 `income` / `expense` 仍兼容） |
...
```csv
日期,类型,分类,金额,支付方式,备注
2026-07-01,支出,餐饮,35.50,支付宝,公司楼下午饭
2026-07-02,支出,交通,8.00,微信,地铁通勤
2026-07-05,支出,购物,199.00,银行卡,买衣服
2026-07-10,收入,工资,12000.00,银行卡,7月工资
2026-07-15,支出,娱乐,88.00,微信,看电影
```
